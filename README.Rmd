...
```
Figure 2. Results of a dissolved oxygen percent saturation test for four sensors. Sensor #675016 recorded outside of an acceptable range for 99.9% of the test period, and was therefore flagged for re-calibration.
